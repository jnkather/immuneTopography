...
myImageType = 'PD1val' // define image type
loArea = '15'	   // minimum area; this and the next variables vary between staining types
hiArea = '100'	   // maximum area 
inThre = '0.07'    // cell detection intensity threshold
threOn = '0.18'	   // positive cell detection threshold
// caution: also changed thresholdCompartment for PD1 !!!
...
runPlugin('qupath.imagej.detect.nuclei.PositiveCellDetection', '{"detectionImageBrightfield": "Hematoxylin OD",  "requestedPixelSizeMicrons": 0.5,  "backgroundRadiusMicrons": 8.0,  "medianRadiusMicrons": 0.0,  "sigmaMicrons": 2.0,  "minAreaMicrons": ' + loArea + ',  "maxAreaMicrons": ' + hiArea + ',  "threshold": ' + inThre + ',  "maxBackground": 2.0,  "watershedPostProcess": true,  "excludeDAB": false,  "cellExpansionMicrons": 3.0,  "includeNuclei": true,  "smoothBoundaries": true,  "makeMeasurements": true,  "thresholdCompartment": "Cell: DAB OD mean",  "thresholdPositive1": ' + threOn + ',  "thresholdPositive2": 0.4,  "thresholdPositive3": 0.6,  "singleThreshold": true}');
